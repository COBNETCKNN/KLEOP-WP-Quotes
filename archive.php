...
<?php 
	// Displaying content from rich text box area created with ACF
	$post_id = get_queried_object()->term_id; // category term ID = 3
	$value = get_field( 'archive_page_text_box', "category_" . $post_id );
...
<?php 
	// Displaying content from Education text box area created with ACF
	$post_id = get_queried_object()->term_id; // category term ID = 3
	$value = get_field( 'tags_taxonomy_text_box', "post_tag_" . $post_id );
